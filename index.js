...
function transformProduct(product) {
  ...
  // Detect style from GroupDescription (most reliable)
  ...
  if (!style) {
    console.log(`Skipping: ${product.SKU} | GroupDesc: ${product.GroupDescription}`);
    return null;
  }
  
  console.log(`Found: ${product.SKU} | Style: ${style} | GroupDesc: ${product.GroupDescription}`);
